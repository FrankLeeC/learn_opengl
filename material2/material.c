...
int main(int argc, char** argv) {
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        light_color[0] = (float)sin(glfwGetTime() * 2.0f);
        light_color[1] = (float)sin(glfwGetTime() * 0.7f);
        light_color[2] = (float)sin(glfwGetTime() * 1.3f);
        glm_vec_scale(light_color, 0.2, light[0]);
        glm_vec_scale(light_color, 0.5, light[1]);
        ...
        glUniform3f(glGetUniformLocation(cube_program, "view_position"), camera_pos[0], camera_pos[1], camera_pos[2]);
        ...
        glUniform3fv(glGetUniformLocation(cube_program, "material.ambient"), 1, material[0]);
        glUniform3fv(glGetUniformLocation(cube_program, "material.diffuse"), 1, material[1]);
        glUniform3fv(glGetUniformLocation(cube_program, "material.specular"), 1, material[2]);
