...
int main(int argc, char** argv) {
    ...
    glTextureParameteri(texture, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);  // 设置x轴纹理方式
    glTextureParameteri(texture, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);  // 设置y轴纹理方式
    glTextureParameteri(texture, GL_TEXTURE_MIN_FILTER, GL_NEAREST);  // 设置缩小时的纹理过滤
    glTextureParameteri(texture, GL_TEXTURE_MAG_FILTER, GL_NEAREST);  // 设置放大时的纹理过滤
